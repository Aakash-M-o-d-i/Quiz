...
// //   if (username && joinCode && joinCode === localStorage.getItem('entryCode')) {
// //       entryContainer.style.display = 'none';
// //       quizContainer.style.display = 'block';
// //       displayQuestion();
// //   } else {
// //       alert('Invalid username or entry code!');
// //   }
// // });
...
// //   // Update admin panel ranking table
// //   displayRankings();
// // }
...
//   if (window.parent) {
//       window.parent.postMessage('updateScores', '*');
//   }
// }
...
function updateUserScore(username, score) {
    const userScores = JSON.parse(localStorage.getItem('userScores')) || [];
    const userIndex = userScores.findIndex(user => user.username === username);

    if (userIndex !== -1) {
        userScores[userIndex].score = score;
    } else {
        userScores.push({ username, score });
    }
